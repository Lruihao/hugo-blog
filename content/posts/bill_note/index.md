...
valine 可以實現無後端，那我是不是也可以，leancloud 文檔走一波，然後“數據表”設計一下，其實是 leancloud-storage Object ，於是有了以下東西，源碼放在 <http://github.com/Lruihao/bill-note>

<a href="http://github.com/Lruihao/bill-note" target="_blank" class="LinkCard">bill-note</a>
